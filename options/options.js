...
const itemLinkList =  ["홈페이지", "인트라넷", "DIMA C", "전자출결", "장비대여", "버스시간표", "에브리타임", "나의 학과", "사이트맵", "공지사항", "수강신청", "학사일정", "외출외박신청", "시간표 조회", "교과목 조회", "학교 이메일", "교내 전화번호", "LMS", "창의융합교양학부", "시설대여", "실습실대여", "채용정보", "입시 홈페이지", "도서관", "디마티비", "웹증명발급"];
const itemDepartmentList = ["방송기술계열", "음향제작과", "뉴미디어콘텐츠과", "영상제작과", "방송보도제작과", "방송극작과", "광고제작과", "디지털영상디자인과", "공연예술계열", "영화예술과", "무대미술과", "실용음악학부", "패션스타일리스트과", "엔터테인먼트경영과", "전공심)"];
